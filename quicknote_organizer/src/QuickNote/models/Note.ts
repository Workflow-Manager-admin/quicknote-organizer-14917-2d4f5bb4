...
export class Note {
   ...
   */
  static create(title: string, content: string, category: string): Note {
   ...
   */
  update(data: { title?: string; content?: string; category?: string }): Note {
   ...
   */
  getContentSnippet(length: number = 80): string {
